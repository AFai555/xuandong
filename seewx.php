...
function cart_case($pid){
	...
	$t_html = '<a href="'.$row['link'].'" target="_blank">'.$row['title'].'</a> <a href="'.$row['case_url'].'" target="_blank">['.$row['isbao'].']</a> ';
	return $t_html;
}

$gid=encrypt($_SERVER["QUERY_STRING"], 'D');
$row=_get_one('wxcart',$gid);
?>
...
<div class="adminbox">
  ...
  <table width="100%" border=0 align="center" cellpadding=0 cellspacing=1 bordercolor=#c9d3e9 style="margin-top:20px;margin-bottom:20px;border-collapse:collapse;table-layout:fixed;">
  <tr><td align="center">
  <table width="760px" border=1 align="center" cellpadding=0 cellspacing=1 bordercolor=#c9d3e9 style="margin-top:20px;margin-bottom:20px;border-collapse:collapse;table-layout:fixed;">
    <tr>      
      <td align="center"><p class="see_con" style="font-size:24px"><strong><?php echo $row['title']?></strong></p></td>
    </tr> 
      <td  align="center" style="width:760px;overflow-x:hidden;overflow-y:hidden; word-wrap:break-word;">
...
<div id="cleft_box"  style="position: absolute; right: 50px; top: 200px; padding:0px; margin:0px; overflow:hidden; width:200px;">
     
<p class="see_con"><?php echo cart_case($row['pid'])?></p>
        </div>
</body>
</html>

...
if ($_GET['act']=='checkbox' & $_GET['lx']==3) {
	if (isset($_POST['ID'])) {
		...
		_query("DELETE FROM meiti WHERE id in ({$ids})");
		ShowMsg('成功：批量删除成功','meiti.php');
		exit();
	}else{
...
<body>
<div class="menubox"><strong>当前位置：</strong>媒体 &gt; 媒体管理</div>
<div class="adminbox">
<div id="menu">
<dl>
	<dt class="dropdown"><span><a href="meiti_add.php">添加媒体</a></span>
    </dt>
</dl>
</div>
...
<?php
$sql="SELECT * FROM meiti ORDER BY px_id ASC";
_page($sql,12);
...
?>
    <tr>
      ...
      <td width="15%" align="center"><a href="meiti_edit.php?id=<?php echo $row['id']?>" class="icon_edit">编辑</a> <a href="?act=del&id=<?php echo $row['id']?>" class="icon_del" onclick="delcfm()">删除</a></td>
    </tr>
<?php }?> 
  </table>
</form>

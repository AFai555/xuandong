...
if ($_GET['act']=='xiugai') {
	...
	_update('weibo_case',$data,$id);
	ShowMsg('成功：媒体案例修改成功，继续添加',$PreviousUrl);
}
$row=_get_one('weibo_case',$_GET['id']);
?>
...
<body>
<div class="menubox"><strong>当前位置：</strong>媒体 &gt; 媒体案例管理 &gt; 修改媒体案例</div>
<div class="mainbox">
...
-->
      ...
      <dt><em>是否隐藏：</em>
       ...
       <dt><em>粉丝量：</em>
        ...
        <input name="fsl" type="text" id="price" size="10" value="<?php echo $row['isbao']?>"  />万
      </dt>
      <dt>

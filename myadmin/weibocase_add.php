...
if ($_GET['act']=='add') {
	...
	_insert('weibo_case',$data);
	ShowMsg('成功：媒体案例添加成功，继续添加','weibocase_add.php?mid='.$data['mid']);
}
$mid=$_GET['mid'];
?>
...
<body>
<div class="menubox"><strong>当前位置：</strong>媒体 &gt; 媒体案例管理 &gt; 添加媒体案例</div>
<div class="mainbox">
...
-->
      ...
      隐藏
       ...
       <dt><em>粉丝量：</em>
          <input name="fsl" type="text" id="price" size="10" />万

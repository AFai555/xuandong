...
if ($_GET['act']=='add') {
	...
	_insert('luntan_case',$data);
	ShowMsg('成功：论坛案例添加成功，继续添加','luntancase_add.php?mid='.$data['mid']);
}
$mid=$_GET['mid'];
?>
...
<body>
<div class="menubox"><strong>当前位置：</strong>论坛 &gt; 论坛案例管理 &gt; 添加论坛案例</div>
<div class="mainbox">
    ...
    <dl>
      ...
      <dt><em>频道链接：</em>
        <input name="link" type="text" id="link" value="" size="50" />
         ...
         <dt><em>板块：</em>
          <input name="fsl" type="text" id="price" size="50" />
       </dt>
      <dt><em>板块链接：</em>

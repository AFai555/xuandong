...
if ($_GET['act']=='xiugai') {
	...
	_update('luntan_case',$data,$id);
	ShowMsg('成功：论坛案例修改成功，继续添加',$PreviousUrl);
}
$row=_get_one('luntan_case',$_GET['id']);
?>
...
<body>
<div class="menubox"><strong>当前位置：</strong>论坛 &gt; 论坛案例管理 &gt; 修改论坛案例</div>
<div class="mainbox">
  <form  name="add" method="post" action="?act=xiugai">
    ...
    <dl>
      ...
      <dt><em>频道链接：</em>
        ...
        <input name="fsl" type="text" id="price" size="50" value="<?php echo $row['isbao']?>"  />
      </dt>
      <dt><em>板块链接：</em>

...
<?php endif ;?> 
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#C9D3E9" class="xuqiu">
      ...
      <tr>
        ...
        <td>
            <p><em>文档上传成功，继续填写下面的信息，然后提交审核即可 </em></p>
            <p/>
           <p  class="mc"> <a href="gaojian2_add.php">返回重新上传文档</a></p>
      ...
      <tr>
        ...
        <td>
        <p class="mc"><input name="title" type="text" size="80" maxlength="28" style="height: 25px;" />
        （标题字数应小于28个汉字）</p>

...
<?php require 'user_top.php'?>
    <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#C9D3E9" class="xuqiu">
      <tr>
        <td width="120" height="40"><p class="mc">上传的文档</p></td>
        <td>
        <em>已经上传的文档改状态暂不允许修改 </em>
        </td>
      </tr>
      <tr>
        <td height="40"><p class="mc">文章标题<em>*必填</em></p></td>
        <td>
<p class="mc"><input name="title" type="text" value="<?php echo $row['title']?>" size="80" maxlength="20" style="height: 25px;" />
        （标题字数应小于20个汉字）</p>
              </td>
      </tr>
      <tr>

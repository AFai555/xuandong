...
<div class="meitiBox">
    ...
    <div class="add_buzhuo">
    	...
    	<a href="gaojian3_add.php" class="online">方式四：转载来源</a>
    </div>
    <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#C9D3E9" class="xuqiu">
      <tr>
        <td width="130" height="40"><p class="mc">所选媒体</p></td>
      ...
      <tr>
        <td height="130"><p class="mc">稿件转载链接<em>*必填</em></p></td>
        <td>
        <p class="mc"><textarea name="content" id="content" style="width:800px"></textarea>
        </p>
        <p class="mc pt10">例如：http://www.cankaoxiaoxi.com/roll/roll10/2016/0215/1076327.shtml </p> 
